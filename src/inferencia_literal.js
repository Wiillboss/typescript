...
let maria = 'Maria'; // A variável maria é do tipo literal 'Maria', ou seja, ela só pode receber o valor 'Maria'. Se tentarmos atribuir outro valor, como 'Willian', o TypeScript irá gerar um erro, pois não é permitido atribuir um valor diferente do tipo literal definido.
